...
class ResNet(nn.Module):
    def __init__(self, start_channel_size: int, kernel_size: int, layers_size: List[int], regressor_hidden_size: List[int]):
        ...
        self.max_pool = nn.MaxPool1d(3, stride=2, padding=1).to(self.device)
