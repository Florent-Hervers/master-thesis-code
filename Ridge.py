...
def main():
    ...
    if (len(sys.argv) < 2):
        raise Exception(f"The phenotype to use should be given as first positional argument")
    ...
    lambdas = np.linspace(0.001, 15, 50)
    ...
    for i,lambda_val in enumerate(lambdas):
        ...
        with open(f"Results/ridge_{pheno}.json", "w") as f:
            results = {
